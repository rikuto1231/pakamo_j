...
public class Main {
    ...
    private boolean chkCheat(){
        ...
        if( isCheatB && isCheatR ){
            ...
            Util.print("[青]%sに不正があります。失格！",redcorner.Team.getName());
        }else if( isCheatR ){
    ...
    private void gameMain(){
        ...
        while(true){
            ...
            //通算成績を表示
            Util.print("-----[通算成績]-----");
            Util.print("[青]%d勝：%s",blueWinNum,redcorner.Team.getName());
    ...
    private void dispTitle(){
        String blueTeam = redcorner.Team.getName();
    ...
    private void dispMember(){
        String blueTeam = redcorner.Team.getName();
        String redTeam = redcorner.Team.getName();
        Pokamon blueFighters[] = redcorner.Team.getFighters();
